...
#define X_STEP_BIT         5  // Uno Digital Pin 3
#define Y_STEP_BIT         7  // Uno Digital Pin 5
#define Z_STEP_BIT         9  // Uno Digital Pin 7
#define X_DIRECTION_BIT    4  // Uno Digital Pin 2
#define Y_DIRECTION_BIT    6  // Uno Digital Pin 4
#define Z_DIRECTION_BIT    8  // Uno Digital Pin 6
...
#define STEPPERS_DISABLE_BIT    10  // Uno Digital Pin 8
...
#define X_LIMIT_BIT     10  // Uno Digital Pin 8
#define Y_LIMIT_BIT     10  // Uno Digital Pin 9
#define Z_LIMIT_BIT     10  // Uno Digital Pin 10
...
#define SPINDLE_ENABLE_BIT   11  // Uno Digital Pin 12

#define SPINDLE_DIRECTION_DDR   DDRB
#define SPINDLE_DIRECTION_PORT  PORTB
#define SPINDLE_DIRECTION_BIT   12  // Uno Digital Pin 13 (NOTE: D13 can't be pulled-high input due to LED.)

#define COOLANT_FLOOD_DDR   DDRC
#define COOLANT_FLOOD_PORT  PORTC
#define COOLANT_FLOOD_BIT   13  // Uno Analog Pin 3
...
// #define ENABLE_M7  // Mist coolant disabled by default. Uncomment to enable.
  ...
  #define COOLANT_MIST_BIT   14 // Uno Analog Pin 4
#endif  
...
#define PIN_RESET        15  // Uno Analog Pin 0
#define PIN_FEED_HOLD    16  // Uno Analog Pin 1
#define PIN_CYCLE_START  17  // Uno Analog Pin 2
